...
struct AddView: View {
    let addproject = ProjectModel(title: String(), createtime: Date())
    ...
    func saveButtonPressed() {
        ...
        listViewModel.addItem(title: textFieldText, timemood: timemoodInt, funtitle: FieldText_sec, verytitle: FieldText_thi, copytitle: FieldText_copy, delete: deleteBool, projectModel: addproject, groupTitle: groupTitle, groupCreateTime: groupTime)
